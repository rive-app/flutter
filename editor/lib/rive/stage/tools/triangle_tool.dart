...
class TriangleTool extends StageTool {
  static final TriangleTool instance = TriangleTool();
  ...
  void updateDrag(Vec2D worldMouse) {
    ...
    _triangle.width = _end[0] - _start[0];
    _triangle.height = _end[1] - _start[1];
    _triangle.x = _triangle.width / 2;
    _triangle.y = _triangle.height / 2;
  }
