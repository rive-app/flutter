        ...
        child: ListenableBuilder<SelectionContext<SelectableItem>>(
          ...
          builder: (context, selection, _) {
            ...
            if (builders.isNotEmpty) {
              ...
              // list items the same height (or as similar as possible) in order
              // to gaurantee a smooth scrolling experience when virtualizing
              // lots of items. This is why group expansion works by adding more
              // items to the ListView instead of just creating one large item
              // in the ListView.
