...
abstract class KeyedPropertyBase<T extends RiveCoreContext> extends Core<T> {
  ...
  void changeNonNull() {
    if (_keyedObjectId != null) {
      onPropertyChanged(
          keyedObjectIdPropertyKey, _keyedObjectId, _keyedObjectId);
    }
    if (_propertyKey != null) {
      onPropertyChanged(propertyKeyPropertyKey, _propertyKey, _propertyKey);
    }
  }
  ...
  void writeRuntimeProperties(BinaryWriter writer,
    ...
    if (_propertyKey != null && exports(propertyKeyPropertyKey)) {
      context.uintType.writeRuntimeProperty(
          propertyKeyPropertyKey, writer, _propertyKey, propertyToField);
    }
  }
