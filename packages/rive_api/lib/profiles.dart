...
class RiveProfilesApi<T extends RiveOwner> {
  ...
  Future<void> updateInfo(
    ...
    if (owner is RiveTeam) {
      return _updateTeamInfo(owner, name, username, location, website, bio,
          twitter, instagram, isForHire);
    } else {
      return _updateUserInfo(owner, name, username, location, website, bio,
          twitter, instagram, isForHire);
    }
  }

  // PUT /api/teams/<teamId>
  Future<void> _updateTeamInfo(
    RiveTeam team,
    String name,
    String username,
    String location,
