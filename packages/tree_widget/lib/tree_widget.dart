...
class _InputHelper<T> extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final controller = TreeControllerProvider.of(context);
...
class TreeControllerProvider extends InheritedWidget {
  ...
  static TreeController of(BuildContext context) => context
      .dependOnInheritedWidgetOfExactType<TreeControllerProvider>()
      .controller;

  @override
  bool updateShouldNotify(TreeControllerProvider old) =>
