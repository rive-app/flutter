...
./bin/core_generator  --definitions-folder=./defs/ --core-context=RiveCoreContext --output-folder=../packages/rive_flutter_runtime/ --package=rive --runtime --runtime-core-folder=../packages/rive_core/
